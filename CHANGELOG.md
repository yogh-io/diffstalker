...
- **Text in the web UI can be selected and copied.** Commit messages,
  hashes, authors, dates, file paths and errors now support normal browser
  text selection. Control labels and diff line numbers stay out of selections.
